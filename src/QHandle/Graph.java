...
public class Graph {
	...
	public static String[] Bytes = new String[10];
	...
	public String P = getClass().getResource("/").getPath();
	...
	public static void BG(double[][] Data,String chartTitle,String Category,String XLabel, String YLabel,LinkedList<String> XCategories,LinkedList<String> XGroupsLabels,int Type) {
		try {
		JFreeChart BarChart = ChartFactory.createBarChart(chartTitle, Category, YLabel,createDataset(Data,XCategories,XGroupsLabels,Type),PlotOrientation.VERTICAL,true,true,false);	
				//Save BarChart
			  ...
			  String Path =System.getProperty("catalina.base")+"/webapps/";//+"/domains/group155database.com/";
			  
			  final File file1 = new File(Path+chartTitle+""+Count+".png");
			  ...
			  Files.add(chartTitle+""+Count+".png");
			  
			  Bytes[Count] = Graph.encodeFileToBase64Binary(file1);
			  ...
			  ChartUtilities.saveChartAsPNG(file1, BarChart, WIDTH, HEIGHT, info,false,9);
			  } catch (Exception e) {
