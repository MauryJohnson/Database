...
public class QS {
	...
	public static String SetQuery(String Param,int type) {
		...
		if(type==0) {
			...
			ret+="#Busiest periods of week..... TIME, within 1-12 hour periods\r\n" + 
					"#Busiest period for beer, then food, then soft drink\r\n" + 
					"#transactions for givne BAR\r\n" + 
					"SET @HourCount1:=0;\r\n" + 
					"SET @HourCount2:=0;\r\n" + 
					...
					"(\r\n" + 
					"SELECT @HourCount1:=COUNT(*) FROM beer_transactions T2\r\n" + 
					"WHERE DAYOFWEEK(T2.date_of_transaction)-DAYOFWEEK(T.date_of_transaction)=0\r\n" + 
					"AND T2.bar=T.bar\r\n" + 
					")\r\n" + 
					"+\r\n" + 
					"(\r\n" + 
					"SELECT @HourCount2:=COUNT(*) FROM beer_transactions T2\r\n" + 
					"WHERE DAYOFWEEK(T2.date_of_transaction)-DAYOFWEEK(T.date_of_transaction)=1\r\n" + 
					"AND T2.bar=T.bar\r\n" + 
					")\r\n" + 
					"+\r\n" + 
					"(\r\n" + 
					"SELECT @HourCount3:=COUNT(*) FROM beer_transactions T2\r\n" + 
					"WHERE DAYOFWEEK(T2.date_of_transaction)-DAYOFWEEK(T.date_of_transaction)=2\r\n" + 
					"AND T2.bar=T.bar\r\n" + 
					")\r\n" + 
					"+\r\n" + 
					"(\r\n" + 
					"SELECT @HourCount4:=COUNT(*) FROM beer_transactions T2\r\n" + 
					"WHERE DAYOFWEEK(T2.date_of_transaction)-DAYOFWEEK(T.date_of_transaction)=3\r\n" + 
					"AND T2.bar=T.bar\r\n" + 
					")\r\n" + 
					"+\r\n" + 
					"(\r\n" + 
					"SELECT @HourCount5:=COUNT(*) FROM beer_transactions T2\r\n" + 
					"WHERE DAYOFWEEK(T2.date_of_transaction)-DAYOFWEEK(T.date_of_transaction)=4\r\n" + 
					"AND T2.bar=T.bar\r\n" + 
					")\r\n" + 
					"+\r\n" + 
					"(\r\n" + 
					"SELECT @HourCount6:=COUNT(*) FROM beer_transactions T2\r\n" + 
					"WHERE DAYOFWEEK(T2.date_of_transaction)-DAYOFWEEK(T.date_of_transaction)=5\r\n" + 
					"AND T2.bar=T.bar\r\n" + 
					")\r\n" + 
					"+\r\n" + 
					"(\r\n" + 
					"SELECT @HourCount7:=COUNT(*) FROM beer_transactions T2\r\n" + 
					"WHERE DAYOFWEEK(T2.date_of_transaction)-DAYOFWEEK(T.date_of_transaction)=6\r\n" + 
					"AND T2.bar=T.bar\r\n" + 
					")\r\n" + 
					"\r\n" + 
					"\r\n" + 
			...
			ret+="SELECT * FROM beers\r\n" + 
					"ORDER BY RAND() LIMIT 20";
		}
		else if(type==16) {
			ret+="SELECT * FROM bars\r\n" + 
					"ORDER BY RAND() LIMIT 20";	
		}
		return ret;
	}
	...
	public static String[] ParseType(String[]Queries, String Table) {
		...
		for(int i=0; i<Queries.length;i+=1) {
			...
			for(;j<Queries[i].length();j+=1) {
				if(Character.isAlphabetic(Queries[i].substring(j, j+1).toCharArray()[0])) {
					LastPosition = j;
					break;
				}
			}
			...
			for(j=0; j<Queries[i].length() && j<6;j+=1) {
